...
const InnerProductMagnifier = React.memo((props) => {
  ...
  //   (itemId, showSnackbar) => {
  //     dispatch(createWishListDataInitiate(itemId, null, showSnackbar));
  //     setTimeout(() => {
  //       dispatch(loadInnerProductDataInitiate(linkName));
  //     }, 200);
  //   },
  ...
  //     dispatch(deleteWishListDataInitiate(itemId, null, showSnackbar));
  //     setTimeout(() => {
  //       dispatch(loadInnerProductDataInitiate(linkName));
  //     }, 200);
  //   },
  ...
  //  const addWishListHandler = useCallback(
  //    (itemId) => {
  //      dispatch(createWishListDataInitiate(itemId, showSnackbar));
  //      setTimeout(() => {
  //        dispatch(loadInnerProductDataInitiate(linkName));
  //      }, 200);
  //    },
  //    [dispatch, showSnackbar, linkName]
  //  );

  //  const deleteWishListHandler = useCallback(
  //    (itemId) => {
  //      dispatch(deleteWishListDataInitiate(itemId, showSnackbar));
  //      setTimeout(() => {
  //        dispatch(loadInnerProductDataInitiate(linkName));
  //      }, 200);
  //    },
  ...
  const deleteWishListHandler = (status, itemId) => {
    if (status === true && itemId) {
      try {
        ...
        console.error("Error deleting wishlist item in inner product:", error);
      }
    }
  };
