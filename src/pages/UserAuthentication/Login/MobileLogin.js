...
import { loginWithMobileInitiate } from "../../../redux/actions/mobileLoginActions";
import {
  initialValues,
...
const MobileLogin = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      dispatch(loginWithMobileInitiate(values, navigate));
    } catch (error) {}
  };
  const formFields = ["phone_number", "password"];
          ...
          >
            <FormControl fullWidth sx={{ marginBottom: "15px" }}>
              ...
              <TextField
                ...
                id="phone_number"
                name="phone_number"
                // value={phone_numberLoginData.phone_number || receivedData}
                // onChange={onInputChange}
                size="small"
                // value={receivedData}
                value={
                  receivedData
                    ? (formik.values.phone_number = receivedData)
